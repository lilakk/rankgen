...
sim_tokenizer = AutoTokenizer.from_pretrained("princeton-nlp/sup-simcse-roberta-large")
sim_model = AutoModel.from_pretrained("princeton-nlp/sup-simcse-roberta-large")
sim_model.eval()
...
parser.add_argument('--output_file', default="ensemble_expt/simcse_full_rerank_sup_roberta_large.jsonl", type=str)
